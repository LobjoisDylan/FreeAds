    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading">Enrengistrer une Annonces ou <a href="{{ route('annonce') }}">Voir les annonces</a></div>
                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('home') }}">
                        ...
                        <div class="form-group{{ $errors->has('password') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="picture" type="text" class="form-control" name="picture" required>
                        ...
                        <div class="form-group{{ $errors->has('ville') ? ' has-error' : '' }}">
                            <label for="ville" class="col-md-4 control-label">Vile</label>
                        ...
                        <div class="form-group{{ $errors->has('produit') ? ' has-error' : '' }}">
                            <label for="type_de_produit" class="col-md-4 control-label">Produit</label>
